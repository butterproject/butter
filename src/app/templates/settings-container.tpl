<div class="settings-container">
    ...
    <section id="torrentCollection" class="advanced">
        <div class="title"><%= i18n.__("Torrent Collection") %></div>
        <div class="content">
                <span>
                    ...
                    <i class="open-torrentCollection-folder fa fa-folder-open-o tooltipped" data-toggle="tooltip" data-placement="auto" title="<%= i18n.__("Open Torrent Collection Directory") %>"></i>
